...
textToBinaryEl.addEventListener('input', ({target}) =>
binaryToTextEl.value = textToBinary(target.value));
// binaryToText("00100000 00100000 01100100 00100000 00110000 00100000 00110001 00110010 00110011 00100000 00110101")
binaryToTextEl.addEventListener('input', ({target}) =>
textToBinaryEl.value = binaryToText(target.value));
